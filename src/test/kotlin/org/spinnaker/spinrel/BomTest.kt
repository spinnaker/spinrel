...
class BomTest {
    ...
    fun `all fields parsed`() {
        ...
        expect {
            ...
            that(bom.services).isEqualTo(
                mapOf(
                    "clouddriver" to ServiceInfo("8004330e7cdc090a921e26a1fe1ac904c4923dc9", "6.5.0-20191224172815"),
                    "deck" to ServiceInfo("81386a3c55608dd1c31a30eff1d46f7c39627f30", "2.14.0-20191220202816"),
    ...
    fun `round trip bom`() {
        val inputBom = Bom(
            ...
            services = mapOf(
                "clouddriver" to ServiceInfo(commit = "abcdef", version = "999"),
