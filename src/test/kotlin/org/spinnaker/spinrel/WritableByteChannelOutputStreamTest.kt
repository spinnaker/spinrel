...
object WritableByteChannelOutputStreamTest {
    ...
    fun `write single bytes`() {
        val testChannel = TestByteChannel()
        val subject = WritableByteChannelOutputStream(testChannel, BUF_SIZE)
        ...
        val expectedWriteOperations = Iterables.partition(1..100, BUF_SIZE).toByteLists()
