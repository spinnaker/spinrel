...
class DefaultSpinnakerServiceRegistry @Inject constructor() : SpinnakerServiceRegistry {
    ...
    private val serviceInfos = setOf(
        ...
        SpinnakerServiceInfo("monitoring-daemon", repositoryName = "spinnaker-monitoring"),
